...
func NewAnimation() *Animation {
	return &Animation{
		colorEnabled: true,
		maskColorMap: map[rune]termbox.Attribute{
			'r': termbox.ColorRed, 'R': termbox.ColorLightRed,
			'g': termbox.ColorGreen, 'G': termbox.ColorLightGreen,
			'y': termbox.ColorYellow, 'Y': termbox.ColorLightYellow,
			'b': termbox.ColorBlue, 'B': termbox.ColorLightBlue,
			'm': termbox.ColorMagenta, 'M': termbox.ColorLightMagenta,
			'c': termbox.ColorCyan, 'C': termbox.ColorLightCyan,
			'w': termbox.ColorLightGray, 'W': termbox.ColorWhite,
			'k': termbox.ColorBlack, 'K': termbox.ColorDarkGray,
